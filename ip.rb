...
class BefungeIP
  attr_accessor :mark, :id, :parent, :delta, :coords, :stackstack, :storeoffset, :prevhash, :fingerhash, :parent, :hovermode, :switchmode, :stringmode, :queuemode, :invertmode, :sleep
  ...
  def sysinfo(num)
    ...
    push 1381320277
    # Amount of bytes per cell; ruby bignums _seem_ to have a limit of 32*1024*1024, so 4194304 bytes.
    push 4194304
